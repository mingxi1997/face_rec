...
def lfw_test(net):
    ...
    groups = group_image(images, Config.test_batch_size)

    feature_dict = dict()
    for group in groups:
        d = featurize(group, Config.test_transform, net, Config.device)
        feature_dict.update(d) 
    accuracy, threshold = compute_accuracy(feature_dict, Config.test_list, Config.test_root) 
